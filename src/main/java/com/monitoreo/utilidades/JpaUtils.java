...
public class JpaUtils {
 ...
 public static EntityManager getEntityManager(String unitName) {
  ...
  try {
   ...
   throw new RuntimeException("Error creando conexion : "
     + e.getMessage(), e);
  }
 }
 ...
 public static Object executeSingleResultNamedQuery(EntityManager em,
   String namedQuery) {
 ...
 public static List executeListResultNamedQuery(EntityManager em,
   String namedQuery) {
  Query consulta = em.createNamedQuery(namedQuery);
 ...
 public static Object executeSingleResultQuery(EntityManager em,
